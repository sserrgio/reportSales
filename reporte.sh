...
sql="select count(*) from vicidial_list where list_id='1999' and entry_date >= date_add('$fechaI',interval 5 hour) and 
...
sql3="select count(*) from vicidial_list where list_id='1999' and ( modify_date >= '$fechaI%' and modify_date < '$fechaF' 
